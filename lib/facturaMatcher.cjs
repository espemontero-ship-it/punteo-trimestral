...
async function procesarFacturaSubida({ hoja, clave, rutaBlob, nombreOriginal, concepto, analisis, subidoPor }) {
  ...
  const insert = await query(
    `INSERT INTO facturas (proveedor_clave, ruta_blob, nombre_original, numero,
                            importes, totales, fechas, es_imagen, concepto, estado, subido_por)
     VALUES ($1,$2,$3,$4,$5,$6,$7,$8,$9,'sin_match',$10)
     RETURNING *`,
    [
      ...
      analisis.esImagen, concepto || null, subidoPor || null,
    ]
  );
